...
const sumOfPoint = userInfoList.map(programmer => programmer.point).reduce((acc, point) => acc + point);
console.log(sumOfPoint);
console.log('=================================================');

// 2. Jimmy Gosling의 이름을 가진 함수형으로 작성하여 오브젝트를 출력하기
const searchedName = userInfoList.find(programmer => programmer.name === 'Jimmy Gosling2');\
console.log('=================================================');
